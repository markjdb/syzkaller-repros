Syzkaller hit 'Fatal trap NUM: general protection fault in ip_mfilter_free' bug.

Fatal trap 9: general protection fault while in kernel mode
cpuid = 1; apic id = 01
instruction pointer	= 0x20:0xffffffff81253b83
stack pointer	        = 0x28:0xfffffe00517c3ab0
frame pointer	        = 0x28:0xfffffe00517c3af0
code segment		= base 0x0, limit 0xfffff, type 0x1b
			= DPL 0, pres 1, long 1, def32 0, gran 1
processor eflags	= interrupt enabled, resume, IOPL = 0
current process		= 1140 (syz-executor2970990)
rdi: deadc0dedeadc0de rsi: 000000005e4a6f28 rdx: ffffffff818a5ab2
rcx: fffff8002abd4060  r8: 0000000000000000  r9: 0000000000000000
rax: fffff8002abd4000 rbx: deadc0dedeadc0de rbp: fffffe00517c3af0
r10: 0000000000000001 r11: fffff8002a804c60 r12: fffff800030be000
r13: fffff800030b8a00 r14: 0000000000000000 r15: fffff800031ea640
trap number		= 9
panic: general protection fault
cpuid = 1
time = 1702783602
KDB: stack backtrace:
db_trace_self_wrapper() at db_trace_self_wrapper+0x49/frame 0xfffffe00517c37c0
vpanic() at vpanic+0x1a4/frame 0xfffffe00517c3900
panic() at panic+0x43/frame 0xfffffe00517c3960
trap_fatal() at trap_fatal+0x54d/frame 0xfffffe00517c39e0
calltrap() at calltrap+0x8/frame 0xfffffe00517c39e0
--- trap 0x9, rip = 0xffffffff81253b83, rsp = 0xfffffe00517c3ab0, rbp = 0xfffffe00517c3af0 ---
ip_mfilter_free() at ip_mfilter_free+0x273/frame 0xfffffe00517c3af0
inp_freemoptions() at inp_freemoptions+0x27c/frame 0xfffffe00517c3b40
sorele_locked() at sorele_locked+0x1bd/frame 0xfffffe00517c3b70
soclose() at soclose+0x13d/frame 0xfffffe00517c3be0
_fdrop() at _fdrop+0x3a/frame 0xfffffe00517c3c10
closef() at closef+0x2a1/frame 0xfffffe00517c3ca0
fdescfree() at fdescfree+0x652/frame 0xfffffe00517c3d70
exit1() at exit1+0x70b/frame 0xfffffe00517c3de0
sys_exit() at sys_exit+0xd/frame 0xfffffe00517c3df0
amd64_syscall() at amd64_syscall+0x26b/frame 0xfffffe00517c3f30
fast_syscall_common() at fast_syscall_common+0xf8/frame 0xfffffe00517c3f30
--- syscall (1, FreeBSD ELF64, exit), rip = 0x24cf8a, rsp = 0x8204f0658, rbp = 0x8204f0670 ---
KDB: enter: panic
[ thread pid 1140 tid 100129 ]
...
rsp         0xfffffe00517c37a0
rbp         0xfffffe00517c37c0
rsi                        0x1
rdi                          0
r8                           0
r9          0x8080808080808080
r10         0xfffffe00517c3670
...
db> show proc
Process 1140 (syz-executor2970990) at 0xfffffe0051dfd060:
 state: NORMAL
 uid: 0  gids: 0, 0, 5
 parent: pid 796 at 0xfffffe0051d80000
 ABI: FreeBSD ELF64
 flag: 0x10002000  flag2: 0x40000
 arguments: /root/syz-executor2970990700
 reaper: 0xfffffe0004213040 reapsubtree: 1
 sigparent: 20
 vmspace: 0xfffff80003e329a0
   (map 0xfffff80003e329a0)
   (map.pmap 0xfffff80003e32a60)
   (pmap 0xfffff80003e32ad0)
 threads: 1
100129                   Run     CPU 1                       syz-executor2970990
db> ps
  pid  ppid  pgrp   uid  state   wmesg   wchan               cmd
 1140   796   795     0  RE      CPU 1                       syz-executor2970990
  797   795   795     0  S       nanslp  0xffffffff8223d160  syz-executor2970990
  796   795   795     0  S       nanslp  0xffffffff8223d160  syz-executor2970990
  795   793   795     0  Ss      nanslp  0xffffffff8223d160  syz-executor2970990
  793   762   793     0  Ss      select  0xfffff80003f89040  sshd
  780     1   780     0  Ss+     ttyin   0xfffff800036c50b0  getty
  777     1   777     0  Ss      select  0xfffff8002a08f9c0  logger
  771     1    16     0  S+      piperd  0xfffffe0051b83e38  logger
  770   769    16     0  S+      nanslp  0xffffffff8223d160  sleep
  769     1    16     0  S+      wait    0xfffffe0051dfb020  sh
  766     1   766     0  Ss      nanslp  0xffffffff8223d161  cron
  762     1   762     0  Ss      select  0xfffff80003cf76c0  sshd
  662     1   662     0  Ss      kqread  0xfffff80003922c00  syslogd
  463     1   463     0  Ss      select  0xfffff8002a08fe40  devd
  360     1   360    65  Ss      select  0xfffff80003cf79c0  dhclient
  276     1   276     0  Ss      select  0xfffff8002a08ff40  dhclient
...
100066                   D       launds  0xffffffff82360084  [laundry: dom0]
100067                   D       umarcl  0xffffffff814fb3b0  [uma]
...
100059                   D       -       0xfffff800034afd00  [CAM taskq]
 1139   797   795     0  Z                                   syz-executor2970990
db> show all locks
db> show malloc
       ...
       ufs_dirhash           24            5K           24
        ...
        local_apic            1            2K            1
         ipsec-saq            2            2K            2
           ...
           pwddesc           32            2K         1141
           CAM DEV            1            2K            2
       ether_multi           25            2K          699
         proc-args           49            2K         2066
               msi           13            2K           13
           session           13            2K           29
             lockf           15            2K           18
          pci_link           16            2K           16
...
db> show uma
   ...
   mbuf_jumbo_page   4096    1088     944       19592       0     254    8323072        0
          BUF TRIE    144     189   13335         528       0      62    1947456        0
       malloc-4096   4096     363       1        1767       0       2    1490944        0
        malloc-128    128    9980     126       10987       0     126    1293568        0
      mbuf_cluster   2048     508       0         508       0     254    1040384        0
              mbuf    256    1347     950       32303       0     254     588032        0
      ...
      malloc-65536  65536       6       2           8       0       1     524288        0
          ...
          lkpicurr    168       2    3094           2       0      62     520128        0
            socket    960      17     491        1406       0     254     487680        0
       UMA Slabs 0    112    3303       3        3303       0     126     370272        0
        RADIX NODE    144    1770     299       29472       0      62     297936        0
       malloc-2048   2048     134      10         136       0       8     294912        0
     FPU_save_area   2432     102       8         139       0       4     267520        0
        256 Bucket   2048     107      13         341       0       8     245760        0
         VM OBJECT    264     855      75       14488       0      30     245520        0
             VNODE    448     503      37         512       0      30     241920        0
        malloc-256    256     848      82         871       0      62     238080        0
         malloc-64     64    3279     312        4673       0     254     229824        0
         malloc-16     16   12658     342       14013       0     254     208000        0
            THREAD   1824     100      12         129       0       8     204288        0
            DEVCTL   1024       0     192          90       0       0     196608        0
         UMA Zones    768     212       2         212       0      16     164352        0
         malloc-32     32    4341     321        4888       0     254     149184        0
      ...
      malloc-32768  32768       3       1           4       0       1     131072        0
       ...
       mbuf_packet    256       0     508          69       0     254     130048        0
          ksiginfo    112      37    1007          65       0     126     116928        0
       malloc-1024   1024     104       8         117       0      16     114688        0
         FFS inode    200     483      77         490       0      62     112000        0
       S VFS Cache    104     942      72         991       0     126     105456        0
        malloc-128    128     546     229        1200       0     126      99200        0
         MAP ENTRY     96     720     288       43835       0     126      96768        0
        128 Bucket   1024      40      43         206       0      16      84992        0
        malloc-256    256     142     173         578       0      62      80640        0
          UMA Kegs    384     199       4         199       0      30      77952        0
              PROC   1376      33      22        1140       0       8      75680        0
         64 Bucket    512      72      64        1129       0      30      69632        0
       ...
       malloc-4096   4096       4       2          15       0       2      24576        0
          rl_entry     40      29     577          35       0     254      24240        0
           ...
           rtentry    168      11     133          13       0      62      24192        0
             ...
             Files     80      66     234        6768       0     126      24000        0
          8 Bucket     80      36     264         134       0     126      24000        0
        ...
        SLEEPQUEUE     88     113     143         113       0     126      22528        0
         ...
         malloc-32     32      30     600         470       0     254      20160        0
         16 Bucket    144      41      99         172       0      62      20160        0
          2 Bucket     32      47     583         278       0     254      20160        0
 ...
 epoch_record pcpu    256       4      60           4       0      62      16384        0
   ...
   tcp_inpcb ports     32       1     377           1       0     254      12096        0
         ...
         malloc-16     16      15     735         362       0     254      12000        0
       ...
       malloc-4096   4096       1       1           1       0       2       8192        0
      vtnet_tx_hdr     24       1     333        9765       0     254       8016        0
...
setsockopt$inet_mreqn(r0, 0x0, 0xc, &(0x7f00000000c0)={@multicast2, @loopback}, 0xc)
