Syzkaller hit 'Fatal trap 12: page fault in soo_aio_queue' bug.

Fatal trap 12: page fault while in kernel mode
cpuid = 1; apic id = 01
fault virtual address	= 0x0
fault code		= supervisor read data, page not present
instruction pointer	= 0x20:0xffffffff84102395
stack pointer	        = 0x28:0xfffffe001a74f6c0
frame pointer	        = 0x28:0xfffffe001a74f750
code segment		= base 0x0, limit 0xfffff, type 0x1b
			= DPL 0, pres 1, long 1, def32 0, gran 1
processor eflags	= interrupt enabled, resume, IOPL = 0
current process		= 822 (syz-executor6280375)
trap number		= 12
panic: page fault
cpuid = 1
time = 1627207253
KDB: stack backtrace:
db_trace_self_wrapper() at db_trace_self_wrapper+0xde/frame 0xfffffe001a74eff0
vpanic() at vpanic+0x639/frame 0xfffffe001a74f0b0
panic() at panic+0x1b3/frame 0xfffffe001a74f1c0
trap_fatal() at trap_fatal+0x14b9/frame 0xfffffe001a74f2e0
trap_pfault() at trap_pfault+0x2e2/frame 0xfffffe001a74f3e0
trap() at trap+0x15ef/frame 0xfffffe001a74f5f0
calltrap() at calltrap+0x14/frame 0xfffffe001a74f5f0
--- trap 0xc, rip = 0xffffffff84102395, rsp = 0xfffffe001a74f6c0, rbp = 0xfffffe001a74f750 ---
soo_aio_queue() at soo_aio_queue+0x305/frame 0xfffffe001a74f750
aio_aqueue() at aio_aqueue+0x29fe/frame 0xfffffe001a74fa10
amd64_syscall() at amd64_syscall+0xa4e/frame 0xfffffe001a74fbf0
fast_syscall_common() at fast_syscall_common+0x104/frame 0xfffffe001a74fbf0
--- syscall (0, FreeBSD ELF64, nosys), rip = 0x2332aa, rsp = 0x7fffffffea68, rbp = 0x7fffffffea80 ---
KDB: enter: panic
[ thread pid 822 tid 100104 ]
...
rbx                          0
rsp         0xfffffe001a74ef90
rbp         0xfffffe001a74eff0
rsi                        0x1
...
r11                  0x6bb8dc0
r12                          0
r13         0xfffffe003b384f01
r14         0xfffffe003b384f68
r15         0xffffffff8632c622
rip         0xffffffff83f97477  kdb_enter+0x1c7
rflags                    0x46
kdb_enter+0x1c7:        movq    $0x87024010,%rdi
db> show proc
Process 822 (syz-executor6280375) at 0xfffffe003b382a70:
 state: NORMAL
 uid: 0  gids: 0, 0, 5
 parent: pid 820 at 0xfffffe003b382538
 ABI: FreeBSD ELF64
 flag: 0x10004000  flag2: 0
 arguments: /root/syz-executor628037590
 reaper: 0xfffffe0011383538 reapsubtree: 1
 sigparent: 20
 vmspace: 0xfffffe003af3a3e0
   (map 0xfffffe003af3a3e0)
   (map.pmap 0xfffffe003af3a4a0)
   (pmap 0xfffffe003af3a500)
 threads: 1
100104                   Run     CPU 1                       syz-executor6280375
db> ps
  pid  ppid  pgrp   uid  state   wmesg   wchan               cmd
  826     0     0     0  DL      aiordy  0xfffffe003b393000  [aiod4]
  825     0     0     0  DL      aiordy  0xfffffe003b393538  [aiod3]
  824     0     0     0  DL      aiordy  0xfffffe003b393a70  [aiod2]
  823     0     0     0  DL      aiordy  0xfffffe003b382000  [aiod1]
  822   820   820     0  R       CPU 1                       syz-executor6280375
  820   818   820     0  Ss      pause   0xfffffe003b3825e8  csh
  818   781   818     0  Ss      select  0xfffffe001a907640  sshd
  797     1   797     0  Ss+     ttyin   0xfffffe001aae8cb0  getty
  793     1   793     0  Ss      select  0xfffffe001a9077c0  logger
  788     1    22     0  S+      piperd  0xfffffe003ae755d0  logger
  787   786    22     0  S+      nanslp  0xffffffff86ff77a0  sleep
  786     1    22     0  S+      wait    0xfffffe0039a24a70  sh
  781     1   781     0  Ss      select  0xfffffe001a9078c0  sshd
  758     1   758    25  Ss      pause   0xfffffe003ae6f0b0  sendmail
  755     1   755     0  Ss      select  0xfffffe001a907bc0  sendmail
  726     1   726     0  Ss      nanslp  0xffffffff86ff77a1  cron
  646     1   646     0  Ss      select  0xfffffe001a907b40  syslogd
  448     1   448     0  Ss      select  0xfffffe001a921340  devd
  352     1   352    65  Ss      select  0xfffffe001a921040  dhclient
  270     1   270     0  Ss      select  0xfffffe001a9213c0  dhclient
...
db> show all locks
Process 822 (syz-executor6280375) thread 0xfffffe003ae64740 (100104)
exclusive sleep mutex so_rcv (so_rcv) r = 0 (0xfffffe003af198a8) locked @ /root/freebsd/sys/kern/sys_socket.c:822
db> show malloc
...
db> show uma
   ...
   mbuf_jumbo_page   4096    1088     920       14447       0     254    8224768        0
      malloc-16384  16384     112       0         112       0       1    1835008        0
        malloc-128    128   10785      34       10848       0     126    1384832        0
       malloc-4096   4096     323       1         483       0       2    1327104        0
          BUF TRIE    144     169    8987         447       0      62    1318464        0
              pbuf   2624       0     269           0       0       2     705856        0
              mbuf    256    1346     964       22246       0     254     591360        0
        malloc-512    512    1026      14        1034       0      30     532480        0
      malloc-65536  65536       6       1          37       0       1     458752        0
         vmem btag     56    7212     107        7212       0     254     409864        0
        RADIX NODE    144    2368     370       28422       0      62     394272        0
            lkpimm    160       1    2324           1       0      62     372000        0
          lkpicurr    160       2    2323           2       0      62     372000        0
       UMA Slabs 0    112    2998      23        2998       0     126     338352        0
       malloc-2048   2048     136       8         160       0       8     294912        0
             VNODE    448     523      44         553       0      30     254016        0
         VM OBJECT    264     904      56       11707       0      30     253440        0
        256 Bucket   2048     101      13        2828       0       8     233472        0
      ...
      malloc-65536  65536       1       2          70       0       1     196608        0
       malloc-4096   4096      44       2         831       0       2     188416        0
      ...
      malloc-32768  32768       2       2           4       0       1     131072        0
       ...
       S VFS Cache    104     992     100        1072       0     126     113568        0
         MAP ENTRY     96     776     400       36958       0     126     112896        0
       ...
       malloc-8192   8192      11       2          14       0       1     106496        0
        ...
        128 Bucket   1024      47      24         694       0      16      72704        0
         malloc-64     64     988     146       19812       0     254      72576        0
              PROC   1336      43      11         826       0       8      72144        0
      mbuf_cluster   2048      30       2          30       0     254      65536        0
      malloc-32768  32768       2       0          54       0       1      65536        0
        malloc-256    256     231       9         478       0      62      61440        0
           VMSPACE   2544      18       6         802       0       4      61056        0
         filedesc0   1072      44       5         827       0       8      52528        0
        malloc-128    128     374      29        3640       0     126      51584        0
        malloc-128    128     348      55       28257       0     126      51584        0
        malloc-384    384     117      13         156       0      30      49920        0
         32 Bucket    256      37     113         544       0      62      38400        0
      ...
      malloc-16384  16384       1       0          65       0       1      16384        0
       ...
       malloc-1024   1024       4       4           4       0      16       8192        0
        ...
        malloc-512    512       3      13          40       0      30       8192        0
         ...
         16 Bucket    144      34      22        1819       0      62       8064        0
          4 Bucket     48       5     163          50       0     254       8064        0
          2 Bucket     32      41     211         581       0     254       8064        0
         ...
         malloc-16     16       7     493           7       0     254       8000        0
          8 Bucket     80      25      75         280       0     126       8000        0
 ...
 epoch_record pcpu    256       4      12           4       0      62       4096        0
      ...
      vtnet_tx_hdr     24       1     166        6821       0     254       4008        0
            ttyinq    160      15      10          45       0      62       4000        0
             ripcb    496       1       7           1       0     254       3968        0
     udplite_inpcb    496       1       7           1       0     254       3968        0
...
shutdown(r0, 0x0)
aio_read(&(0x7f0000000680)={r0, 0x7d350000000000, 0x0, 0x0, [0x6, 0x7], 0x9, 0x20, 0x6d5, {0x4, 0x7, 0x0}, {0x4, 0x18, @sival_ptr=0xffffffff, @ke_flags=0x4}})
...
int main(void)
{
  ...
  *(uint64_t*)0x20000688 = 0x7d350000000000;
  *(uint64_t*)0x20000690 = 0;
  *(uint64_t*)0x20000698 = 0;
  *(uint32_t*)0x200006a0 = 6;
  *(uint32_t*)0x200006a4 = 7;
  *(uint64_t*)0x200006a8 = 9;
  *(uint32_t*)0x200006b0 = 0x20;
  *(uint32_t*)0x200006b4 = 0x6d5;
  *(uint64_t*)0x200006b8 = 4;
  *(uint64_t*)0x200006c0 = 7;
  *(uint64_t*)0x200006c8 = 0;
  *(uint32_t*)0x200006d0 = 4;
  *(uint32_t*)0x200006d4 = 0x18;
  *(uint64_t*)0x200006d8 = 0xffffffff;
  *(uint16_t*)0x200006e0 = 4;
  syscall(SYS_aio_read, 0x20000680ul);
  return 0;
}
