Syzkaller hit 'panic: excl->share' bug.

panic: excl->share
cpuid = 0
time = 1705185548
KDB: stack backtrace:
db_trace_self_wrapper() at db_trace_self_wrapper+0x49/frame 0xfffffe007591d250
vpanic() at vpanic+0x1a4/frame 0xfffffe007591d390
panic() at panic+0x43/frame 0xfffffe007591d3f0
witness_checkorder() at witness_checkorder+0x112d/frame 0xfffffe007591d5d0
lockmgr_slock() at lockmgr_slock+0xb7/frame 0xfffffe007591d610
_vn_lock() at _vn_lock+0x7f/frame 0xfffffe007591d680
vn_close1() at vn_close1+0xd5/frame 0xfffffe007591d700
zfs_setextattr() at zfs_setextattr+0xa3d/frame 0xfffffe007591da60
VOP_SETEXTATTR_APV() at VOP_SETEXTATTR_APV+0x5c/frame 0xfffffe007591da90
extattr_set_vp() at extattr_set_vp+0x173/frame 0xfffffe007591db60
kern_extattr_set_path() at kern_extattr_set_path+0x17b/frame 0xfffffe007591dc90
sys_extattr_set_link() at sys_extattr_set_link+0x95/frame 0xfffffe007591ddf0
amd64_syscall() at amd64_syscall+0x26b/frame 0xfffffe007591df30
fast_syscall_common() at fast_syscall_common+0xf8/frame 0xfffffe007591df30
--- syscall (0, FreeBSD ELF64, syscall), rip = 0x2474ea, rsp = 0x82071af18, rbp = 0x82071af70 ---
KDB: enter: panic
[ thread pid 817 tid 100190 ]
...
rsp         0xfffffe007591d230
rbp         0xfffffe007591d250
rsi                        0x1
rdi                          0
r8                           0
r9          0x8080808080808080
r10         0xfffffe007591d100
...
db> show proc
Process 817 (syz-executor5324831) at 0xfffffe0063f725a0:
 state: NORMAL
 uid: 0  gids: 0, 0, 5
 parent: pid 815 at 0xfffffe007627f560
 ABI: FreeBSD ELF64
 flag: 0x10000000  flag2: 0
 arguments: /root/syz-executor532483185
 reaper: 0xfffffe00086bb040 reapsubtree: 1
 sigparent: 20
 vmspace: 0xfffff8000ffb0738
   (map 0xfffff8000ffb0738)
   (map.pmap 0xfffff8000ffb07f8)
   (pmap 0xfffff8000ffb0868)
 threads: 1
100190                   Run     CPU 0                       syz-executor5324831
db> ps
  pid  ppid  pgrp   uid  state   wmesg   wchan               cmd
  817   815   813     0  R       CPU 0                       syz-executor5324831
  816   814   813     0  R       CPU 1                       syz-executor5324831
  815   813   813     0  R                                   syz-executor5324831
  814   813   813     0  R                                   syz-executor5324831
  813   811   813     0  Ss      nanslp  0xffffffff8271a7e0  syz-executor5324831
  811   780   811     0  Ss      select  0xfffff8000495c6c0  sshd
  798     1   798     0  Ss+     ttyin   0xfffff80004ad8cb0  getty
  794     1   794     0  Ss      select  0xfffff800047684c0  logger
  789     1    17     0  S+      piperd  0xfffffe0076029888  logger
  788   787    17     0  S+      nanslp  0xffffffff8271a7e1  sleep
  787     1    17     0  S+      wait    0xfffffe00086bc060  sh
  784     1   784     0  Ss      nanslp  0xffffffff8271a7e0  cron
  780     1   780     0  Ss      select  0xfffff8000453b240  sshd
  680     1   680     0  Ss      kqread  0xfffff800065c8900  syslogd
  481     1   481     0  Ss      select  0xfffff800047686c0  devd
  377     1   377    65  Ss      select  0xfffff8000495c940  dhclient
  293     1   293     0  Ss      select  0xfffff80004768840  dhclient
  290     1   290     0  Ss      select  0xfffff8000495cbc0  dhclient
...
100140                   D       -       0xfffff8000492c000  [dp_sync_taskq_0]
100141                   D       -       0xfffff8000492c000  [dp_sync_taskq_1]
100142                   D       -       0xfffff80004209900  [dp_zil_clean_taskq_]
100143                   D       -       0xfffff80004209900  [dp_zil_clean_taskq_]
100144                   D       -       0xfffff80004209800  [z_zrele_0]
100145                   D       -       0xfffff80004209800  [z_zrele_1]
100146                   D       -       0xfffff80004209700  [z_unlinked_drain_0]
100147                   D       -       0xfffff80004209700  [z_unlinked_drain_1]
100163                   D       tx->tx_ 0xfffff80004fcb550  [txg_thread_enter]
100164                   D       tx->tx_ 0xfffff80004fcb530  [txg_thread_enter]
100165                   D       mmp->mm 0xfffffe0063e5a4d0  [mmp_thread_enter]
100166                   D       t->zthr 0xfffff8000f3e8748  [raidz_expand]
100167                   D       t->zthr 0xfffff8000fee3748  [z_indirect_condense]
100168                   D       t->zthr 0xfffff8000fee3948  [z_livelist_destroy]
100169                   D       t->zthr 0xfffff8000fee2948  [z_livelist_condense]
100170                   D       t->zthr 0xfffff8000fee3c48  [z_checkpoint_discar]
...
100082                   D       -       0xffffffff81f54d70  [deadlkres]
...
db> show all locks
Process 817 (syz-executor5324831) thread 0xfffff80010e05000 (100190)
exclusive lockmgr zfs (zfs) r = 0 (0xfffff801070ad770) locked @ /root/freebsd/sys/contrib/openzfs/module/os/freebsd/zfs/zfs_vnops_os.c:694
Process 816 (syz-executor5324831) thread 0xfffff80033d12740 (100201)
exclusive lockmgr zfs (zfs) r = 0 (0xfffff80033f925b0) locked @ /root/freebsd/sys/kern/vfs_lookup.c:1248
db> show malloc
              Type        InUse        MemUse     Requests
           solaris        18620        10516K        94708
         sysctloid        38626         2261K        38721
          vfscache            3         2049K            3
              kobj          323         1292K          488
            devbuf         1333         1144K         3748
               pcb           17         1037K           46
         ufs_quota            1         1024K            1
          vfs_hash            1         1024K            1
           callout            2          512K            2
...
zio_buf_comb_131072 131072      98     134        3009       0       1   30408704        0
   mbuf_jumbo_page   4096    1088     944       19528       0     254    8323072        0
     zio_buf_16384  16384      75     333        1412       0       2    6684672        0
       UMA Slabs 0    112   58364      22       58364       0     126    6539232        0
          BUF TRIE    144       0   26516           0       0      62    3818304        0
        malloc-256    256   13712     238       25216       0      62    3571200        0
       malloc-4096   4096      79     343         847       0       2    1728512        0
        malloc-128    128   12673      68       13105       0     126    1630848        0
       malloc-4096   4096     323       1         488       0       2    1327104        0
zio_buf_comb_65536  65536       1      19          43       0       1    1310720        0
          2 Bucket     32     539    2107       64553       0     254      84672        0
        malloc-256    256     156     159        2503       0      62      80640        0
        malloc-256    256     245      70         345       0      62      80640        0
zio_buf_comb_24576  24576       0       3          17       0       1      73728        0
     zio_buf_12288  12288       0       6          34       0       1      73728        0
       malloc-8192   8192       4       5          72       0       1      73728        0
         64 Bucket    512      63      73         897       0      30      69632        0
        malloc-128    128     376     151        2088       0     126      67456        0
        malloc-128    128     360     167       29574       0     126      67456        0
      zio_buf_8192   8192       1       7          56       0       1      65536        0
      ...
      malloc-32768  32768       2       0           2       0       1      65536        0
        ...
        malloc-256    256     124     131         398       0      62      65280        0
         32 Bucket    256      90     165        1124       0      62      65280        0
              PROC   1376      34      10         817       0       8      60544        0
       malloc-8192   8192       5       2           7       0       1      57344        0
         filedesc0   1072      35      14         818       0       8      52528        0
         malloc-32     32     972     666       15848       0     254      52416        0
            ttyinq    160     180     145         540       0      62      52000        0
             NAMEI   1024       1      47       11004       0      16      49152        0
      malloc-16384  16384       3       0           3       0       1      49152        0
           pcpu-64     64     454     314         454       0     254      49152        0
          syncache    168       0     264           5       0     254      44352        0
    zio_link_cache     48       0     840       14116       0     254      40320        0
   reference_cache     48      12     828        1970       0     254      40320        0
         udp_inpcb    424       2      88          51       0      30      38160        0
         arc_buf_t     32     219     915        3621       0     254      36288        0
         malloc-64     64      35     532          75       0     254      36288        0
         malloc-64     64      57     510         895       0     254      36288        0
         malloc-64     64     226     341        7935       0     254      36288        0
        malloc-128    128       7     272           7       0     126      35712        0
        malloc-128    128       3     276           3       0     126      35712        0
     routing nhops    256       8     127          13       0      62      34560        0
             g_bio    384       0      90       25972       0      30      34560        0
        malloc-384    384      62      28          69       0      30      34560        0
        malloc-384    384      64      26          64       0      30      34560        0
        malloc-256    256      10     125         193       0      62      34560        0
         TURNSTILE    136     193      59         193       0      62      34272        0
       zio_buf_512    512      13      51          38       0      30      32768        0
 ...
 zio_data_buf_6144   6144       0       4           5       0       1      24576        0
     ...
     zil_zcw_cache     80       0     300           6       0     126      24000        0
             Files     80      67     233        6676       0     126      24000        0
     ...
     zil_lwb_cache    392       1      59           6       0      30      23520        0
        ...
        taskq_zone    160       0     126         512       0      62      20160        0
 ...
 zio_data_buf_3072   3072       1       3           3       0       4      12288        0
   ...
   tcp_inpcb ports     32       1     377           1       0     254      12096        0
      ...
      vtnet_tx_hdr     24       1     333        9468       0     254       8016        0
...
extattr_set_link(&(0x7f0000000040)='./file0\x00', 0x1, &(0x7f0000000080)='..\x00', 0x0, 0x0)
...
void execute_one(void)
{
  ...
  syscall(SYS_open, /*file=*/0x20000000ul, /*flags=*/0x200ul, /*mode=*/0ul);
  memcpy((void*)0x20000040, "./file0\000", 8);
  memcpy((void*)0x20000080, "..\000", 3);
  syscall(SYS_extattr_set_link, /*file=*/0x20000040ul, /*attrnamespace=*/1ul,
