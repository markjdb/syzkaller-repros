Syzkaller hit 'panic: MSan: Uninitialized Memory In copyout():args At Offset 0' bug.

login: panic: MSan: Uninitialized Memory In copyout():args At Offset 0

cpuid = 0
time = 1620533186
KDB: stack backtrace:
db_trace_self_wrapper() at db_trace_self_wrapper+0xde/frame 0xfffffe00847c3520
vpanic() at vpanic+0x656/frame 0xfffffe00847c35e0
panic() at panic+0x1ad/frame 0xfffffe00847c36e0
kmsan_report_hook() at kmsan_report_hook+0x16f/frame 0xfffffe00847c3840
kmsan_copyout() at kmsan_copyout+0x37e/frame 0xfffffe00847c3870
sys___realpathat() at sys___realpathat+0xef4/frame 0xfffffe00847c3a20
amd64_syscall() at amd64_syscall+0xaaf/frame 0xfffffe00847c3bf0
fast_syscall_common() at fast_syscall_common+0xf8/frame 0xfffffe00847c3bf0
--- syscall (0, FreeBSD ELF64, nosys), rip = 0x40111a, rsp = 0x7fffffffea78, rbp = 0x7fffffffeab0 ---
KDB: enter: panic
[ thread pid 718 tid 100080 ]
...
rbx                          0
rsp         0xfffffe00847c34c0
rbp         0xfffffe00847c3520
...
r12                          0
r13                        0x1
r14         0xfffffe00c9cf2fb8
r15         0xffffffff86333744
rip         0xffffffff83fc8007  kdb_enter+0x1c7
rflags                    0x46
kdb_enter+0x1c7:        movq    $0x87022290,%rdi
db> show proc
Process 718 (syz-executor0228693) at 0xfffffe00c9cf0a70:
 state: NORMAL
 uid: 0  gids: 0, 0, 5
 parent: pid 716 at 0xfffffe00c9d1f538
 ABI: FreeBSD ELF64
 flag: 0x10004000  flag2: 0
 arguments: /root/syz-executor022869346
 reaper: 0xfffffe0070a77538 reapsubtree: 1
 sigparent: 20
 vmspace: 0xfffffe00c9ccd000
   (map 0xfffffe00c9ccd000)
   (map.pmap 0xfffffe00c9ccd0c0)
   (pmap 0xfffffe00c9ccd120)
 threads: 1
100080                   Run     CPU 0                       syz-executor0228693
db> ps
  pid  ppid  pgrp   uid  state   wmesg   wchan               cmd
  718   716   716     0  R       CPU 0                       syz-executor0228693
  ...
  691   689    21     0  S+      nanslp  0xffffffff86ff59e0  sleep
...
db> show uma
   ...
   mbuf_jumbo_page   4096    1088     518       13332       0     254    6578176        0
      ...
      malloc-32768  32768       5       0           5       0       1     163840        0
       ...
       FFS2 dinode    256     524       1         535       0      62     134400        0
      malloc-65536  65536       2       0           2       0       1     131072        0
          ksiginfo    112      26    1018          38       0     126     116928        0
        256 Bucket   2048      56       0        2407       0       8     114688        0
        malloc-128    128     840      28        1850       0     126     111104        0
       S VFS Cache    104     995      58        1049       0     126     109512        0
      ...
      malloc-16384  16384       6       0          78       0       1      98304        0
         ...
         MAP ENTRY     96     669     129       35043       0     126      76608        0
      ...
      malloc-16384  16384       2       1           4       0       1      49152        0
        ...
        malloc-128    128     372       0       30914       0     126      47616        0
      ...
      malloc-32768  32768       1       0           1       0       1      32768        0
       ...
       malloc-4096   4096       6       1         272       0       2      28672        0
        ...
        malloc-384    384      65       5          89       0      30      26880        0
        malloc-256    256      93      12         133       0      62      26880        0
       ...
       malloc-1024   1024       9       3           9       0      16      12288        0
         ...
         malloc-64     64     185       4       13308       0     254      12096        0
       ...
       malloc-1024   1024       6       2           6       0      16       8192        0
        malloc-512    512      12       4          12       0      30       8192        0
         malloc-64     64      85      41       11602       0     254       8064        0
         malloc-64     64     113      13         141       0     254       8064        0
             Files     80      65      35        5889       0     126       8000        0
         malloc-16     16     275     225         544       0     254       8000        0
        malloc-128    128      32      30          45       0     126       7936        0
        malloc-256    256      22       8          89       0      62       7680        0
        malloc-256    256      16      14         593       0      62       7680        0
        malloc-256    256      16      14          25       0      62       7680        0
     ...
     FPU_save_area    832       1       8           1       0      16       7488        0
             ...
             NAMEI   1024       1       3       11101       0      16       4096        0
       ...
       malloc-1024   1024       0       4           4       0      16       4096        0
        ...
        malloc-512    512       6       2           7       0      30       4096        0
           pcpu-16     16       7     249           7       0     254       4096        0
             g_bio    408       0      10        5000       0      30       4080        0
         ...
         hostcache     64       1      62           1       0     254       4032        0
          syncache    168       0      24           5       0     254       4032        0
             udpcb     32       2     124          70       0     254       4032        0
               PWD     32      12     114         100       0     254       4032        0
         ...
         16 Bucket    144      14      14         165       0      62       4032        0
          4 Bucket     48       3      81          10       0     254       4032        0
          2 Bucket     32      26     100         550       0     254       4032        0
      vtnet_tx_hdr     24       1     166        6801       0     254       4008        0
         ...
         malloc-16     16      15     235          21       0     254       4000        0
          8 Bucket     80      16      34        2316       0     126       4000        0
...
r1 = openat(0xffffffffffffff9c, &(0x7f0000000900)='.\x00', 0x0, 0x0)
r2 = fcntl$dupfd(r1, 0x0, r0)
freebsd11_mknodat(r2, &(0x7f00000000c0)='./file1\x00', 0x6000, 0x0)
r3 = openat(0xffffffffffffff9c, &(0x7f0000000900)='.\x00', 0x0, 0x0)
__realpathat(r3, &(0x7f0000000000)='./file1\x00', &(0x7f0000000040)=""/14, 0xe, 0x0)
...
int main(void)
{
  ...
  if (res != -1)
    r[1] = res;
  res = syscall(SYS_fcntl, r[1], 0ul, r[0]);
  if (res != -1)
    r[2] = res;
  memcpy((void*)0x200000c0, "./file1\000", 8);
  syscall(SYS_freebsd11_mknodat, r[2], 0x200000c0ul, 0x6000ul, 0);
  memcpy((void*)0x20000900, ".\000", 2);
  res = syscall(SYS_openat, 0xffffff9c, 0x20000900ul, 0ul, 0ul);
  if (res != -1)
    r[3] = res;
  memcpy((void*)0x20000000, "./file1\000", 8);
  syscall(SYS___realpathat, r[3], 0x20000000ul, 0x20000040ul, 0xeul, 0ul);
  return 0;
}
