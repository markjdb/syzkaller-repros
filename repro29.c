Syzkaller hit 'panic: KMSAN: Uninitialized malloc memory from vop_stdallocate+0x5d8' bug.

login: panic: KMSAN: Uninitialized malloc memory from vop_stdallocate+0x5d8
cpuid = 0
time = 1627471417
KDB: stack backtrace:
db_trace_self_wrapper() at db_trace_self_wrapper+0xde/frame 0xfffffe001a6223e0
vpanic() at vpanic+0x639/frame 0xfffffe001a6224a0
panic() at panic+0x1b3/frame 0xfffffe001a6225b0
__msan_warning() at __msan_warning+0x264/frame 0xfffffe001a622700
strncmp() at strncmp+0x1e2/frame 0xfffffe001a622790
g_label_ntfs_taste() at g_label_ntfs_taste+0x1cc/frame 0xfffffe001a622870
g_label_taste() at g_label_taste+0x93b/frame 0xfffffe001a622a10
...
gs                        0x1b
ss                        0x28
rax         0xffffffff8632f0e1
rcx                          0
rdx         0xffffffff8702b000  msan_dummy_orig
rbx                          0
rsp         0xfffffe001a622380
rbp         0xfffffe001a6223e0
rsi                        0x1
...
db> ps
  ...
  828     0     0     0  DL      mdwait  0xfffffe003b3e2000  [md0]
  826   824   820     0  R       (threaded)                  syz-executor9565036
100106                   Run     CPU 1                       syz-executor9565036
100108                   RunQ                                syz-executor9565036
  825   823   820     0  R       (threaded)                  syz-executor9565036
100102                   RunQ                                syz-executor9565036
100107                   RunQ                                syz-executor9565036
  824   822   820     0  R                                   syz-executor9565036
  823   822   820     0  R                                   syz-executor9565036
  822   820   820     0  S       nanslp  0xffffffff86ff77a1  syz-executor9565036
  820   818   820     0  Ss      pause   0xfffffe003b25db20  csh
  818   735   818     0  Ss      select  0xfffffe001a90bac0  sshd
  797     1   797     0  Ss+     ttyin   0xfffffe001aaeccb0  getty
  793     1   793     0  Ss      select  0xfffffe001a90b540  logger
  787     1    22     0  S+      piperd  0xfffffe003ae74ba0  logger
  786   785    22     0  S+      nanslp  0xffffffff86ff77a0  sleep
  785     1    22     0  S+      wait    0xfffffe003ae8da70  sh
  781     1   781    25  Ss      pause   0xfffffe003ae085e8  sendmail
  778     1   778     0  Ss      select  0xfffffe001a90b5c0  sendmail
  739     1   739     0  Ss      nanslp  0xffffffff86ff77a0  cron
  735     1   735     0  Ss      select  0xfffffe001a90b740  sshd
  646     1   646     0  Ss      select  0xfffffe001a8fd040  syslogd
  449     1   449     0  Ss      select  0xfffffe001a90be40  devd
  352     1   352    65  Ss      select  0xfffffe001a9252c0  dhclient
  270     1   270     0  Ss      select  0xfffffe001a90bf40  dhclient
  267     1   267     0  Ss      select  0xfffffe001a8fd240  dhclient
   95     0     0     0  RL                                  [pf purge]
   21     0     0     0  DL      syncer  0xffffffff870ee800  [syncer]
   20     0     0     0  DL      vlruwt  0xfffffe001f850538  [vnlru]
   19     0     0     0  DL      (threaded)                  [bufdaemon]
100070                   D       qsleep  0xffffffff870ed8a0  [bufdaemon]
100071                   D       -       0xffffffff86a0af80  [bufspacedaemon-0]
100083                   D       sdflush 0xfffffe001a9074e8  [/ worker]
...
100075                   D       umarcl  0xffffffff85369fc0  [uma]
...
100060                   D       -       0xffffffff866d7701  [deadlkres]
...
db> show all locks
Process 825 (syz-executor9565036) thread 0xfffffe003ae9d020 (100102)
exclusive sleep mutex umtxql (umtxql) r = 0 (0xffffffff8701cf70) locked @ /root/freebsd/sys/kern/kern_umtx.c:932
db> show malloc
         ...
         sysctloid        30404         1794K        30446
            ...
            linker          227         1500K          240
              kobj          323         1292K          492
            newblk          585         1170K          674
            devbuf         1360         1150K         1378
          vfscache            3         1025K            3
               pcb           16          777K           32
...
db> show uma
   ...
   mbuf_jumbo_page   4096    1088     985       14546       0     254    8491008        0
      malloc-16384  16384     111       0         111       0       1    1818624        0
        malloc-128    128   10786      33       10849       0     126    1384832        0
       malloc-4096   4096     323       2         492       0       2    1331200        0
          BUF TRIE    144     173    8983         457       0      62    1318464        0
              pbuf   2624       0     269           0       0       2     705856        0
              mbuf    256    1346     964       22511       0     254     591360        0
        malloc-512    512    1026      14        1034       0      30     532480        0
      malloc-65536  65536       6       1          37       0       1     458752        0
         vmem btag     56    7281     110        7281       0     254     413896        0
        RADIX NODE    144    2398     424       28804       0      62     406368        0
       ...
       malloc-2048   2048     136       6         160       0       8     290816        0
         VM OBJECT    264     951      39       12130       0      30     261360        0
             VNODE    448     525      33         555       0      30     249984        0
        256 Bucket   2048      99      17        2888       0       8     237568        0
         malloc-64     64    3374      91        3430       0     254     221760        0
            THREAD   1808     108      13         108       0       8     218768        0
         malloc-16     16   12635     115       12683       0     254     204000        0
            DEVCTL   1024       0     192          95       0       0     196608        0
      malloc-65536  65536       3       0           3       0       1     196608        0
      malloc-65536  65536       1       2          70       0       1     196608        0
       malloc-4096   4096      45       1         833       0       2     188416        0
         UMA Zones    768     222       2         222       0      16     172032        0
        malloc-256    256     604      41        1207       0      62     165120        0
         malloc-32     32    4679     109        4823       0     254     153216        0
       FFS2 dinode    256     503      22         530       0      62     134400        0
      malloc-65536  65536       2       0           2       0       1     131072        0
      malloc-32768  32768       2       2           5       0       1     131072        0
       S VFS Cache    104     998     133        1079       0     126     117624        0
          ksiginfo    112      35    1009          67       0     126     116928        0
       malloc-1024   1024     102       6         230       0      16     110592        0
       malloc-8192   8192      11       2          14       0       1     106496        0
         FFS inode    192     503      43         530       0      62     104832        0
         MAP ENTRY     96     841     251       38004       0     126     104832        0
          UMA Kegs    384     207       6         207       0      30      81792        0
         malloc-64     64     988     146       17384       0     254      72576        0
           VMSPACE   2544      22       5         806       0       4      68688        0
              PROC   1336      44       7         828       0       8      68136        0
      mbuf_cluster   2048      30       2          30       0     254      65536        0
      malloc-32768  32768       2       0          54       0       1      65536        0
        malloc-256    256     230      10         477       0      62      61440        0
        128 Bucket   1024      43      16         683       0      16      60416        0
         filedesc0   1072      45      11         829       0       8      60032        0
        malloc-128    128     376      27        3652       0     126      51584        0
        malloc-384    384     114      16         157       0      30      49920        0
        malloc-128    128     348      24       28257       0     126      47616        0
         32 Bucket    256      37     113         484       0      62      38400        0
             NAMEI   1024       0      36       12414       0      16      36864        0
        malloc-256    256     108      27         564       0      62      34560        0
      ...
      malloc-16384  16384       2       0           2       0       1      32768        0
       ...
       malloc-4096   4096       6       1           8       0       2      28672        0
         ...
         64 Bucket    512      48       8         715       0      30      28672        0
             g_bio    384       0      70        4813       0      30      26880        0
      ...
      malloc-16384  16384       1       0          65       0       1      16384        0
       ...
       malloc-1024   1024       9       3           9       0      16      12288        0
        malloc-512    512      10      14          18       0      30      12288        0
             Files     80      82      68        7010       0     126      12000        0
         malloc-16     16     450     300        1333       0     254      12000        0
        malloc-128    128      45      48         167       0     126      11904        0
             unpcb    256      12      33         931       0     254      11520        0
        malloc-384    384      17      13          25       0      30      11520        0
       malloc-4096   4096       2       0           2       0       2       8192        0
       malloc-1024   1024       4       4          57       0      16       8192        0
       ...
       malloc-1024   1024       4       4           4       0      16       8192        0
        malloc-512    512       3      13          42       0      30       8192        0
         ...
         malloc-64     64      24     102        7565       0     254       8064        0
         malloc-64     64      34      92          51       0     254       8064        0
         malloc-64     64       7     119          29       0     254       8064        0
         malloc-32     32      61     191         227       0     254       8064        0
         ...
         16 Bucket    144      32      24        1594       0      62       8064        0
          4 Bucket     48       5     163          43       0     254       8064        0
          2 Bucket     32      41     211         578       0     254       8064        0
         malloc-16     16      25     475         192       0     254       8000        0
         ...
         malloc-16     16       7     493           7       0     254       8000        0
          8 Bucket     80      27      73         290       0     126       8000        0
     ...
     routing nhops    256       8      22          14       0      62       7680        0
       mbuf_packet    256       0      30         103       0     254       7680        0
        ...
        malloc-256    256       1      29          94       0      62       7680        0
 ...
 epoch_record pcpu    256       4      12           4       0      62       4096        0
       ...
       malloc-2048   2048       1       1           1       0       8       4096        0
        ...
        malloc-512    512       2       6           2       0      30       4096        0
         ...
         malloc-64     64       8      55           9       0     254       4032        0
         malloc-32     32       9     117          48       0     254       4032        0
         malloc-32     32       0     126           2       0     254       4032        0
      vtnet_tx_hdr     24       1     166        6925       0     254       4008        0
            ttyinq    160      15      10          45       0      62       4000        0
             ripcb    496       1       7           1       0     254       3968        0
        malloc-128    128      16      15          21       0     126       3968        0
...
ioctl$MDIOCATTACH(r0, 0xc1c06d00, &(0x7f0000000740)={0x0, 0x0, 0x2, &(0x7f00000006c0)='./file0\x00', 0x100000001, 0x2, 0x5, 0x0, 0x0, 0x0, 0x0, [0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x101, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xfffffffc, 0x4]})
r1 = open(&(0x7f0000000080)='./file0\x00', 0x282, 0x0)
posix_fallocate(r1, 0x0, 0x10001)
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint64_t*)0x20000758 = 0x100000001;
    ...
    *(uint32_t*)0x200008fc = 0;
    syscall(SYS_ioctl, r[0], 0xc1c06d00ul, 0x20000740ul);
    break;
  case 2:
    memcpy((void*)0x20000080, "./file0\000", 8);
    res = syscall(SYS_open, 0x20000080ul, 0x282ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(SYS_posix_fallocate, r[1], 0ul, 0x10001ul);
    break;
  }
}
int main(void)
