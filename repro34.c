Syzkaller hit 'panic: freeing mapped page ADDR' bug.

login: panic: freeing mapped page 0xfffffe000812fe60
cpuid = 1
time = 1627491432
KDB: stack backtrace:
db_trace_self_wrapper() at db_trace_self_wrapper+0xde/frame 0xfffffe001a7d12a0
vpanic() at vpanic+0x639/frame 0xfffffe001a7d1360
panic() at panic+0x1b3/frame 0xfffffe001a7d1470
vm_object_collapse() at vm_object_collapse+0x4491/frame 0xfffffe001a7d1610
vm_object_deallocate() at vm_object_deallocate+0x160b/frame 0xfffffe001a7d16c0
vm_map_process_deferred() at vm_map_process_deferred+0x3cf/frame 0xfffffe001a7d1760
vm_map_remove() at vm_map_remove+0x5f1/frame 0xfffffe001a7d1800
vmspace_exit() at vmspace_exit+0x679/frame 0xfffffe001a7d18b0
exit1() at exit1+0x2010/frame 0xfffffe001a7d19d0
sys_sys_exit() at sys_sys_exit+0x65/frame 0xfffffe001a7d1a10
amd64_syscall() at amd64_syscall+0xa4e/frame 0xfffffe001a7d1bf0
fast_syscall_common() at fast_syscall_common+0x104/frame 0xfffffe001a7d1bf0
--- syscall (1, FreeBSD ELF64, sys_sys_exit), rip = 0x233e4a, rsp = 0x7fffffffea68, rbp = 0x7fffffffea80 ---
KDB: enter: panic
[ thread pid 825 tid 100098 ]
...
rbx                          0
rsp         0xfffffe001a7d1240
rbp         0xfffffe001a7d12a0
rsi                        0x1
...
Process 825 (syz-executor1547259) at 0xfffffe003ae23000:
 ...
 threads: 1
100098                   Run     CPU 1                       syz-executor1547259
db> ps
  pid  ppid  pgrp   uid  state   wmesg   wchan               cmd
  825     1   822     0  RE      CPU 1                       syz-executor1547259
  824     1   822     0  R                                   syz-executor1547259
  820   818   820     0  REs     CPU 0                       csh
  818   735   818     0  Ss      select  0xfffffe001a90b740  sshd
  797     1   797     0  Ss+     ttyin   0xfffffe001aaeccb0  getty
  793     1   793     0  Ss      select  0xfffffe001a90bb40  logger
  787   785    22     0  S+      nanslp  0xffffffff86ff77a0  sleep
  786     1    22     0  S+      piperd  0xfffffe001f9a98b8  logger
  785     1    22     0  S+      wait    0xfffffe001f968000  sh
  781     1   781    25  Ss      pause   0xfffffe003a9155e8  sendmail
  778     1   778     0  Ss      select  0xfffffe001a90bbc0  sendmail
  739     1   739     0  Ss      nanslp  0xffffffff86ff77a0  cron
  735     1   735     0  Ss      select  0xfffffe001a90bec0  sshd
  646     1   646     0  Ss      select  0xfffffe003ae90dc0  syslogd
  449     1   449     0  Ss      select  0xfffffe001a8fd240  devd
  352     1   352    65  Ss      select  0xfffffe001a925040  dhclient
  ...
  267     1   267     0  Ss      select  0xfffffe001a9253c0  dhclient
   ...
   21     0     0     0  DL      vlruwt  0xfffffe001f855000  [vnlru]
...
100060                   D       -       0xffffffff866de8c0  [deadlkres]
...
db> show all locks
Process 825 (syz-executor1547259) thread 0xfffffe003a916e40 (100098)
exclusive rw vm object (vm object) r = 0 (0xfffffe003af56108) locked @ /root/freebsd/sys/vm/vm_object.c:870
exclusive rw vm object (vm object) r = 0 (0xfffffe003af39d68) locked @ /root/freebsd/sys/vm/vm_object.c:583
Process 820 (csh) thread 0xfffffe003a917560 (100097)
exclusive sleep mutex pmap (pmap) r = 0 (0xfffffe003ae75120) locked @ /root/freebsd/sys/amd64/amd64/pmap.c:8274
db> show malloc
...
db> show uma
   ...
   mbuf_jumbo_page   4096    1088     966       14630       0     254    8413184        0
      malloc-16384  16384     107       0         107       0       1    1753088        0
        malloc-128    128   10785      65       10848       0     126    1388800        0
       malloc-4096   4096     323       1         483       0       2    1327104        0
          BUF TRIE    144     176    8980         419       0      62    1318464        0
              pbuf   2624       0     264           0       0       2     692736        0
              mbuf    256    1347     978       22651       0     254     595200        0
        malloc-512    512    1026      14        1034       0      30     532480        0
      malloc-65536  65536       6       1          37       0       1     458752        0
         vmem btag     56    7259     132        7259       0     254     413896        0
        RADIX NODE    144    2368     426       28664       0      62     402336        0
            lkpimm    160       1    2324           1       0      62     372000        0
          lkpicurr    160       2    2323           2       0      62     372000        0
       UMA Slabs 0    112    3035      22        3035       0     126     342384        0
       malloc-2048   2048     136       6         160       0       8     290816        0
         VM OBJECT    264     921      39       12107       0      30     253440        0
             VNODE    448     524      34         553       0      30     249984        0
        256 Bucket   2048     100      18        2880       0       8     241664        0
            THREAD   1808     104      17         104       0       8     218768        0
      ...
      malloc-32768  32768       2       0          54       0       1      65536        0
        ...
        128 Bucket   1024      45      14         688       0      16      60416        0
         filedesc0   1072      39      17         826       0       8      60032        0
        malloc-384    384     118      22         153       0      30      53760        0
        malloc-128    128     376      27        3643       0     126      51584        0
        malloc-128    128     353      50       28257       0     126      51584        0
            clpbuf   2624       0      15          27       0       5      39360        0
         32 Bucket    256      36     114         476       0      62      38400        0
             NAMEI   1024       0      36       12409       0      16      36864        0
        malloc-256    256     110      25         562       0      62      34560        0
      ...
      malloc-16384  16384       2       0           2       0       1      32768        0
       ...
       malloc-4096   4096       6       1           8       0       2      28672        0
         ...
         64 Bucket    512      49       7         716       0      30      28672        0
             g_bio    384       0      70        4483       0      30      26880        0
        malloc-384    384      54      16          54       0      30      26880        0
        malloc-256    256      85      20         307       0      62      26880        0
       malloc-4096   4096       4       2         274       0       2      24576        0
         malloc-64     64     259     119        3331       0     254      24192        0
      ...
      malloc-16384  16384       1       0          65       0       1      16384        0
       ...
       malloc-1024   1024       9       3           9       0      16      12288        0
        ...
        malloc-128    128      44      49         162       0     126      11904        0
       ...
       malloc-1024   1024       4       4           4       0      16       8192        0
        ...
        malloc-512    512       3      13          40       0      30       8192        0
         ...
         16 Bucket    144      30      26        1548       0      62       8064        0
          4 Bucket     48       5     163          49       0     254       8064        0
          2 Bucket     32      40     212         571       0     254       8064        0
      vtnet_tx_hdr     24       1     333        6978       0     254       8016        0
             Files     80      79      21        7007       0     126       8000        0
         ...
         malloc-16     16       7     493           7       0     254       8000        0
          8 Bucket     80      30      70         298       0     126       8000        0
     ...
     routing nhops    256       8      22          14       0      62       7680        0
       mbuf_packet    256       0      30         101       0     254       7680        0
        ...
        malloc-256    256       1      29          91       0      62       7680        0
...
# {Threaded:false Collide:false Repeat:false RepeatTimes:0 Procs:1 Slowdown:1 Sandbox:none Fault:false FaultCall:-1 FaultNth:0 Leak:false NetInjection:false NetDevices:false NetReset:false Cgroups:false BinfmtMisc:false CloseFDs:false KCSAN:false DevlinkPCI:false USB:false VhciInjection:false Wifi:false IEEE802154:false Sysctl:false UseTmpDir:false HandleSegv:true Repro:false Trace:false}
...
sigqueue(r0, 0x5d, @sival_int=0x3)
...
{
  intptr_t res = 0;
  syscall(SYS_mprotect, 0x20ffc000ul, 0x3000ul, 5ul);
  syscall(SYS_mlock, 0x20ffc000ul, 0x4000ul);
  res = syscall(SYS_fork);
  if (res != -1)
    r[0] = res;
  syscall(SYS_minherit, 0x20ffc000ul, 0x4000ul, 0ul);
  syscall(SYS_fork);
  syscall(SYS_mprotect, 0x20ffd000ul, 0x3000ul, 7ul);
  syscall(SYS_sigqueue, r[0], 0x5d, 3);
}
int main(void)
{
