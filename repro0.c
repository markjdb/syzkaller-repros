Syzkaller hit 'panic: KMSAN: Uninitialized UMA memory from m_getm2+0x7fe' bug.

login: panic: KMSAN: Uninitialized UMA memory from m_getm2+0x7fe
cpuid = 0
time = 1627017961
KDB: stack backtrace:
db_trace_self_wrapper() at db_trace_self_wrapper+0xde/frame 0xfffffe001a739e40
vpanic() at vpanic+0x639/frame 0xfffffe001a739f00
panic() at panic+0x1b3/frame 0xfffffe001a73a010
__msan_warning() at __msan_warning+0x264/frame 0xfffffe001a73a160
rip_output() at rip_output+0xc54/frame 0xfffffe001a73a340
rip_send() at rip_send+0x3c6/frame 0xfffffe001a73a3e0
sosend_generic() at sosend_generic+0x27e2/frame 0xfffffe001a73a670
sosend() at sosend+0x373/frame 0xfffffe001a73a760
kern_sendit() at kern_sendit+0xeb8/frame 0xfffffe001a73a8a0
sendit() at sendit+0x9a6/frame 0xfffffe001a73a970
sys_sendto() at sys_sendto+0x23f/frame 0xfffffe001a73aa10
amd64_syscall() at amd64_syscall+0xa4e/frame 0xfffffe001a73abf0
fast_syscall_common() at fast_syscall_common+0x104/frame 0xfffffe001a73abf0
--- syscall (0, FreeBSD ELF64, nosys), rip = 0x23324a, rsp = 0x7fffffffea68, rbp = 0x7fffffffea80 ---
KDB: enter: panic
[ thread pid 822 tid 100107 ]
...
rbx                          0
rsp         0xfffffe001a739de0
rbp         0xfffffe001a739e40
rsi                        0x1
...
db> show proc
Process 822 (syz-executor1882344) at 0xfffffe005cac0a70:
 state: NORMAL
 uid: 0  gids: 0, 0, 5
 parent: pid 820 at 0xfffffe005c5ab538
 ABI: FreeBSD ELF64
 flag: 0x10004000  flag2: 0
 arguments: /root/syz-executor188234460
 reaper: 0xfffffe0011383538 reapsubtree: 1
 sigparent: 20
 vmspace: 0xfffffe0043b933e0
   (map 0xfffffe0043b933e0)
   (map.pmap 0xfffffe0043b934a0)
   (pmap 0xfffffe0043b93500)
 threads: 1
100107                   Run     CPU 0                       syz-executor1882344
db> ps
  pid  ppid  pgrp   uid  state   wmesg   wchan               cmd
  822   820   820     0  R       CPU 0                       syz-executor1882344
  820   818   820     0  Ss      pause   0xfffffe005c5ab5e8  csh
  818   781   818     0  Ss      select  0xfffffe001a907b40  sshd
  797     1   797     0  Ss+     ttyin   0xfffffe001aae8cb0  getty
  794     1   794     0  Ss      select  0xfffffe001a907cc0  logger
  788     1    22     0  S+      piperd  0xfffffe005c6118b8  logger
  787   786    22     0  S+      nanslp  0xffffffff86ff77a0  sleep
  786     1    22     0  S+      wait    0xfffffe0043bda538  sh
  781     1   781     0  Ss      select  0xfffffe005c5dbd40  sshd
  758     1   758    25  Ss      pause   0xfffffe005c092b20  sendmail
  755     1   755     0  Ss      select  0xfffffe005c5dba40  sendmail
  726     1   726     0  Ss      nanslp  0xffffffff86ff77a1  cron
  646     1   646     0  Ss      select  0xfffffe001a907d40  syslogd
  448     1   448     0  Ss      select  0xfffffe001a9212c0  devd
  352     1   352    65  Ss      select  0xfffffe005c5dbec0  dhclient
  270     1   270     0  Ss      select  0xfffffe001a907ec0  dhclient
  267     1   267     0  Ss      select  0xfffffe001a8f9040  dhclient
...
100074                   D       umarcl  0xffffffff85366550  [uma]
...
db> show all locks
Process 822 (syz-executor1882344) thread 0xfffffe005cac41e0 (100107)
exclusive sx so_snd_sx (so_snd_sx) r = 0 (0xfffffe005c962d90) locked @ /root/freebsd/sys/kern/uipc_sockbuf.c:467
db> show malloc
...
db> show uma
   ...
   mbuf_jumbo_page   4096    1088     864       14441       0     254    7995392        0
      ...
      malloc-16384  16384     110       0         110       0       1    1802240        0
       ...
       malloc-4096   4096     323       1         483       0       2    1327104        0
          BUF TRIE    144     176    8980         443       0      62    1318464        0
              mbuf    256    1348     872       22257       0     254     568320        0
        malloc-512    512    1026      14        1034       0      30     532480        0
      malloc-65536  65536       6       1          37       0       1     458752        0
         vmem btag     56    7863     104        7863       0     254     446152        0
        RADIX NODE    144    2390     432       28483       0      62     406368        0
            lkpimm    160       1    2324           1       0      62     372000        0
          lkpicurr    160       2    2323           2       0      62     372000        0
       UMA Slabs 0    112    2937      12        2937       0     126     330288        0
       malloc-2048   2048     136       8         160       0       8     294912        0
             VNODE    448     523      44         553       0      30     254016        0
         VM OBJECT    264     904      56       11699       0      30     253440        0
        256 Bucket   2048      99      15        2777       0       8     233472        0
         malloc-64     64    3374      91        3430       0     254     221760        0
            THREAD   1808     107      14         107       0       8     218768        0
      ...
      malloc-65536  65536       1       2          70       0       1     196608        0
       malloc-4096   4096      40       4         827       0       2     180224        0
      ...
      malloc-32768  32768       2       2           4       0       1     131072        0
       malloc-8192   8192      12       3          15       0       1     122880        0
          ksiginfo    112      37    1007          68       0     126     116928        0
      ...
      malloc-16384  16384       1       0          65       0       1      16384        0
       ...
       malloc-1024   1024       4       4           4       0      16       8192        0
        ...
        malloc-512    512       3      13          40       0      30       8192        0
          ...
          rl_entry     40      31     171          33       0     254       8080        0
         ...
         malloc-16     16       7     493           7       0     254       8000        0
          8 Bucket     80      22      78         306       0     126       8000        0
             ripcb    496       2      14           2       0     254       7936        0
 ...
 epoch_record pcpu    256       4      12           4       0      62       4096        0
      ...
      vtnet_tx_hdr     24       1     166        6833       0     254       4008        0
...
setsockopt$inet_int(r0, 0x0, 0x2, &(0x7f0000000000)=0x3f, 0x4)
sendto$inet(r0, 0x0, 0x0, 0x0, &(0x7f0000000100)={0x10, 0x2, 0x2, @multicast1}, 0x10)
...
int main(void)
{
  ...
  *(uint32_t*)0x20000000 = 0x3f;
  syscall(SYS_setsockopt, r[0], 0, 2, 0x20000000ul, 4ul);
